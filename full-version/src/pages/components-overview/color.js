...
const ComponentColor = () => {
  const primaryColorCodeString = `<ColorBox bgcolor="primary.lighter" data={{ label: 'Blue-1', color: '#e6f7ff' }} title="primary.lighter" dark />
...
<ColorBox bgcolor="primary.900" data={{ label: 'Blue-10', color: '#002766' }} title="primary.900" />`;
  ...
  const secondaryColorCodeString = `<ColorBox bgcolor="secondary.lighter" data={{ label: 'Grey-1', color: '#fafafa' }} title="secondary.lighter" dark />
...
<ColorBox bgcolor="secondary.darker" data={{ label: 'Grey-10', color: '#000000' }} title="secondary.darker" />`;
  ...
  const otherColorCodeString = `<ColorBox bgcolor="secondary.A100" data={{ label: 'Grey-A1', color: '#ffffff' }} title="secondary.A100" dark />
...
<ColorBox bgcolor="secondary.A300" data={{ label: 'Grey-A3', color: '#1f1f1f' }} title="secondary.A300" />`;
  ...
  const successColorCodeString = `<ColorBox bgcolor="success.lighter" data={{ label: 'Green-1', color: '#f6ffed' }} title="success.lighter" dark />
...
<ColorBox bgcolor="success.darker" data={{ label: 'Green-10', color: '#092b00' }} title="success.darker" />`;
  ...
  const errorColorCodeString = `<ColorBox bgcolor="error.lighter" data={{ label: 'Red-1', color: '#fff1f0' }} title="error.lighter" dark />
...
<ColorBox bgcolor="error.darker" data={{ label: 'Red-10', color: '#5c0011' }} title="error.darker" />`;
  ...
  const warningColorCodeString = `<ColorBox bgcolor="warning.lighter" data={{ label: 'Gold-1', color: '#fffbe6' }} title="warning.lighter" dark />
      ...
      <ComponentWrapper>
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6} md={4}>
            <MainCard title="Primary Color" codeString={primaryColorCodeString}>
              <Stack>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <MainCard title="Secondary Color" codeString={secondaryColorCodeString}>
              <Stack>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <MainCard title="Other Color" codeString={otherColorCodeString}>
              <Stack>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <MainCard title="Success Color" codeString={successColorCodeString}>
              <Stack>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <MainCard title="Error Color" codeString={errorColorCodeString}>
              <Stack>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <MainCard title="Warning Color" codeString={warningColorCodeString}>
              <Stack>
