...
const IOSSwitch = styled((props) => <Switch focusVisibleClassName=".Mui-focusVisible" disableRipple {...props} />)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      color: '#fff',
      '& + .MuiSwitch-track': {
        backgroundColor: theme.palette.mode === ThemeMode.DARK ? '#2ECA45' : '#65C466',
        opacity: 1,
        border: 0
      },
    ...
    '&.Mui-disabled .MuiSwitch-thumb': {
      color: theme.palette.mode === ThemeMode.DARK ? theme.palette.grey[600] : theme.palette.grey[100]
    },
    '&.Mui-disabled + .MuiSwitch-track': {
  ...
  '& .MuiSwitch-track': {
    borderRadius: 26 / 2,
    backgroundColor: theme.palette.mode === ThemeMode.DARK ? '#39393D' : '#E9E9EA',
    opacity: 1,
...
const AntSwitch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& + .MuiSwitch-track': {
        opacity: 1,
        backgroundColor: theme.palette.mode === ThemeMode.DARK ? '#177ddc' : '#1890ff'
      }
    }
  },
  '& .MuiSwitch-thumb': {
  ...
  '& .MuiSwitch-track': {
    borderRadius: 16 / 2,
    opacity: 1,
    backgroundColor: theme.palette.mode === ThemeMode.DARK ? 'rgba(255,255,255,.35)' : 'rgba(0,0,0,.25)',
    boxSizing: 'border-box'
  }
}));
