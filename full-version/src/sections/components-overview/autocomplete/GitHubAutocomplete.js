...
import { autocompleteClasses, Autocomplete, Box, ButtonBase, ClickAwayListener, InputBase, Popper } from '@mui/material';
  ...
  <StyledPopper id={id} open={open} anchorEl={anchorEl} placement="bottom-start">
    <ClickAwayListener onClickAway={handleClose}>
      <div>
        <Box
          sx={{
            borderBottom: '1px solid {theme.palette.mode === ThemeMode.DARK ? '#eaecef' : '#30363d'}',
            padding: '8px 10px',
            fontWeight: 600
          }}
        >
                ...
                <li {...props}>
                  ...
                  <Box
                    sx={{
                      flexGrow: 1,
                      '& span': {
                        color: theme.palette.mode === ThemeMode.DARK ? '#8b949e' : '#586069'
                      }
                    }}
                  >
                    {option.name}
